...
docker build -t tic-tac-toe-local . or docker build -t tic-tac-toe .

# Run the Container:

docker run -d -p 8080:5500 --name game-test tic-tac-toe-local
Access the game: Open your browser and go to localhost:8080
Stop the game: docker stop game-test
